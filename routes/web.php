...
Route::get('/photos/create', function () { return view('photos.create'); })->name('photos.create.get'); // a form to create new photo

Route::post('/albums/create', [AlbumController::class, 'create'])->name('albums.create.post'); // creates new album
Route::post('/photos/create', [PhotoController::class, 'create'])->name('photos.create.post'); // Add new photo
